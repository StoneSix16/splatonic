...
Tracking for (below) our method and (above) conventional 3DGS SLAM.
...
<h2 class="center-h2">Architecture</h2>
...
{/* Overview of our pipelined architecture. Our architecture is built upon \textsc{MetaSapiens}~\cite{lin2025metasapiens}, a 3DGS accelerator for the forward pass only.  */}
Our architecture is built upon <a href="https://arxiv.org/abs/2407.00435"><span>MetaSapiens</span></a>.
...
```bibtex
@inproceedings{xiao2026splatonic,
